...
import org.exist.xquery.tei.graphing.svg.GroupingSVGGraphics2D;
...
public class RelationGraphSerializer {
	...
	if (svgWidth == 960 && svgHeight == 600) {
        ...
        NodeValue nv = null;
        try {
            // Create an instance of the Grouping SVG Generator
	    GroupingSVGGraphics2D svgGenerator = new GroupingSVGGraphics2D();
