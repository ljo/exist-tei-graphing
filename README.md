...
* svg-width: (for svg output) 960 if less than 27 vertices, 1200 if less than 55 vertices and 1600 if more, integer value
* svg-height: (for svg output) 600 if less than 27 vertices, 800 if less than 55 vertices, and 1000 if more, integer value
